...
namespace IIS.gdfgj88
{
    ...
    public class Paws : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.gdfgj88.Cat.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Cat"})]
        public virtual IIS.gdfgj88.Cat Cat
        {
            get
            {
                ...
                IIS.gdfgj88.Cat result = this.fCat;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View PawsE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("PawsE", typeof(IIS.gdfgj88.Paws));
                }
            }
        }
    }
    ...
    public class DetailArrayOfPaws : ICSSoft.STORMNET.DetailArray
    {
        ...
        //  *** Start programmer edit section *** (IIS.gdfgj88.DetailArrayOfPaws members)

        //  *** End programmer edit section *** (IIS.gdfgj88.DetailArrayOfPaws members)
        ...
        /// </summary>
        public DetailArrayOfPaws(IIS.gdfgj88.Cat fCat) : 
                base(typeof(Paws), ((ICSSoft.STORMNET.DataObject)(fCat)))
        {
        }
        
        public IIS.gdfgj88.Paws this[int index]
        {
            get
            {
                return ((IIS.gdfgj88.Paws)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.gdfgj88.Paws dataobject)
        {
