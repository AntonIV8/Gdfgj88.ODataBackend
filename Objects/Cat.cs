...
namespace IIS.gdfgj88
{
    ...
    [View("CatL", new string[] {
            "CatName as \'Cat name\'",
            "Weight as \'Weight\'"})]
    public class Cat : IIS.gdfgj88.Animal
    {
        
        private string fCatName;
        
        private IIS.gdfgj88.DetailArrayOfPaws fPaws;
        ...
        public virtual IIS.gdfgj88.DetailArrayOfPaws Paws
        {
            get
            {
                ...
                if ((this.fPaws == null))
                {
                    this.fPaws = new IIS.gdfgj88.DetailArrayOfPaws(this);
                }
                IIS.gdfgj88.DetailArrayOfPaws result = this.fPaws;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CatE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatE", typeof(IIS.gdfgj88.Cat));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CatL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatL", typeof(IIS.gdfgj88.Cat));
                }
            }
        }
    }
